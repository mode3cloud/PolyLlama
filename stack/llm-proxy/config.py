...
class LLMProxyConfig:
    ...
    PORT: int = int(os.getenv("LLM_PROXY_PORT", "11435"))
    ...
    MULTI_LLM_JSON_PARSE_RETRIES: int = int(
        os.getenv("MULTI_LLM_JSON_PARSE_RETRIES", "3")
    )
    ...
    def get_llm_provider_configs(cls) -> dict:
        ...
        return {
            "openai": {"api_key": cls.OPENAI_API_KEY, "api_base": cls.OPENAI_API_BASE},
            "anthropic": {"api_key": cls.ANTHROPIC_API_KEY},
            "google": {"api_key": cls.GOOGLE_API_KEY},
            "groq": {"api_key": cls.GROQ_API_KEY},
            "ollama": {"api_base": cls.OLLAMA_API_BASE},
            "lm_studio": {"api_base": cls.LM_STUDIO_API_BASE},
            "openrouter": {
